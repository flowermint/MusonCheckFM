...
var Artist = /** @class */ (function () {
    function Artist(artistData) {
        ...
        this.listeners = ((_c = artistData === null || artistData === void 0 ? void 0 : artistData.stats) === null || _c === void 0 ? void 0 : _c.listeners) || 0;
    }
...
var Album = /** @class */ (function () {
    function Album(albumData) {
        this.name = (albumData === null || albumData === void 0 ? void 0 : albumData.name) || "";
        this.artistName = (albumData === null || albumData === void 0 ? void 0 : albumData.artist) || "";
        this.images = new Image(Array.isArray(albumData === null || albumData === void 0 ? void 0 : albumData.image)
            ? albumData.image
            : [] // fallback для треков без альбома
        );
        this.url = (albumData === null || albumData === void 0 ? void 0 : albumData.url) || "";
    }
    return Album;
}());
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    return [4 /*yield*/, fetch("https://ws.audioscrobbler.com/2.0/?method=track.search&track=".concat(query, "&api_key=").concat(API_KEY, "&format=json&limit=9"))];
                case 1:
                    response = _a.sent();
                ...
                case 2:
                    data = _a.sent();
                    trackPromises = data.results.trackmatches.track.map(function (track) { return __awaiter(_this, void 0, void 0, function () {
                        var trackInfo, trackData;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, fetch("https://ws.audioscrobbler.com/2.0/?method=track.getInfo&artist=".concat(encodeURIComponent(track.artist), "&track=").concat(encodeURIComponent(track.name), "&api_key=").concat(API_KEY, "&format=json"))];
                                case 1:
                                    trackInfo = _a.sent();
                ...
                case 3:
                    tracks = _a.sent();
                    container = document.querySelector(".found-tracks-container");
...
function searchAlbums(query) {
    return __awaiter(this, void 0, void 0, function () {
        var albums, response, data, _i, _a, album, container, _b, albums_1, album, albumItem, albumDescription, albumName, artistName, err_3;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 3, , 4]);
                    albums = [];
                    return [4 /*yield*/, fetch("https://ws.audioscrobbler.com/2.0/?method=album.search&album=".concat(query, "&api_key=").concat(API_KEY, "&format=json&limit=10"))];
                case 1:
                    response = _c.sent();
                    if (response.status != 200) {
                        throw new Error("Something went wrong. Response status is ".concat(response.status));
                ...
                case 2:
                    data = _c.sent();
                    for (_i = 0, _a = data.results.albummatches.album; _i < _a.length; _i++) {
                        album = _a[_i];
                        albums.push(new Album(album));
                    }
                    container = document.querySelector(".found-albums-container");
                    for (_b = 0, albums_1 = albums; _b < albums_1.length; _b++) {
                        album = albums_1[_b];
                        albumItem = document.createElement("div");
                        albumItem.className = "found-album";
                        albumItem.style.backgroundImage = "url(".concat(album.images.getLargest(), ")");
                        albumDescription = document.createElement("div");
                        albumDescription.className = "found-album-description";
                        albumName = document.createElement("a");
                        albumName.className = "found-album-name";
                        albumName.href = "https://last.fm/music/".concat(album.artistName, "/").concat(album.name);
                        albumName.innerHTML = album.name;
                        artistName = document.createElement("a");
                        artistName.className = "found-album-artistname";
                        artistName.href = "https://last.fm/music/".concat(album.artistName);
                        ...
                        container === null || container === void 0 ? void 0 : container.appendChild(albumItem);
                    }
                    return [3 /*break*/, 4];
                case 3:
                    err_3 = _c.sent();
...
function searchArtists(query) {
    return __awaiter(this, void 0, void 0, function () {
        var response, data, artistPromises, artists, fetchImagesPromises, container, elements, _i, artists_1, artist, artistElement, artistDescription, artistName, artistListeners, _a, elements_1, element;
        var _this = this;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, fetch("https://ws.audioscrobbler.com/2.0/?method=artist.search&artist=".concat(query, "&api_key=").concat(API_KEY, "&format=json&limit=10"))];
                case 1:
                    response = _c.sent();
                    if (response.status != 200)
                        throw new Error("Something went wrong. Response status is ".concat(response.status));
                ...
                case 2:
                    data = _c.sent();
                    artistPromises = data.results.artistmatches.artist.map(function (artist) { return __awaiter(_this, void 0, void 0, function () {
                ...
                case 4:
                    _c.sent();
                    container = document.querySelector(".found-artists-container");
                    elements = [];
                    console.log(artists);
                    for (_i = 0, artists_1 = artists; _i < artists_1.length; _i++) {
                        ...
                        artistElement.style.backgroundImage = "url(".concat((_b = artist.image) === null || _b === void 0 ? void 0 : _b.getLargest(), ")");
                        artistDescription = document.createElement("div");
                        ...
                        artistListeners = document.createElement("div");
                        artistListeners.className = "found-artist-listeners";
                        artistListeners.innerHTML = "".concat(formatNumberWithDots(artist.listeners || 0), " listeners");
                        ...
                        container === null || container === void 0 ? void 0 : container.appendChild(artistElement);
                    }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var query = urlParams.get('artist');
    if (query) {
        searchTracks(query);
        searchAlbums(query);
        searchArtists(query);
